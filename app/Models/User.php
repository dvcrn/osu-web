...
class User extends Model implements AuthenticatableContract
{
	...
	{
		if ($this->user_birthday === null) { return; }
	...
	*/
	...
	public function isBAT() { return $this->isGroup(Group::BAT); }
	public function isAdmin() { return $this->isGroup(Group::ADMIN); }
	public function isGMT() { return $this->isGroup(Group::GMT); }
	public function isMAT() { return $this->isGroup(Group::MAT); }
	public function isHax() { return $this->isGroup(Group::HAX); }
	public function isDev() { return $this->isGroup(Group::DEV); }
	public function isMod() { return $this->isGroup(Group::MOD); }
	public function isAlumni() { return $this->isGroup(Group::ALUMNI); }
	public function isRegistered() { return $this->isGroup(Group::REGULAR); }
	public function hasSupported() { return $this->osu_subscriptionexpiry !== null; }
	public function isSupporter() { return $this->osu_subscriber === true; }
	...
	*/
	...
	public function notifications() { return $this->hasMany("App\Models\Notification", "user_id", "user_id"); }
	public function sets() { return $this->hasMany("App\Models\Set", "user_id", "user_id"); }
	public function beatmaps() { return $this->hasManyThrough("App\Models\Beatmap", "Set"); }
	public function posts() { return $this->hasMany("App\Models\Post", "user_id", "user_id"); }
	public function mods() { return $this->hasMany("App\Models\Mod", "user_id", "user_id"); }
	public function api() { return $this->hasOne("App\Models\Api", "user_id", "user_id"); }
	...
	{
		if (!in_array($mode, ["osu", "ctb", "mania", "taiko"], true)) { return; }
	...
	public function countryName() {
		if (!isset($this->flags()["country"])) { return; }
