...
var DefaultCover = React.createClass({
	onClick: function() {
...
var ProfileCoverUploader = React.createClass({
...
var ProfileCoverSelector = React.createClass({
	render: function() {
		var defaultCovers = [];
		for (var i = 1; i <= 8; i++) {
...
var ProfileHeaderInfo = React.createClass({
	render: function() {
		return (
...
var ProfileRank = React.createClass({
	render: function() {
